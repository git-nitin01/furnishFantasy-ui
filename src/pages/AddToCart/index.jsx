...
const AddToCart = () => {
  const { state: { quantity, products, total } = {}, dispatch, setOpen } = useContext(CartContext);
    ...
    <div className="fixed inset-0 overflow-hidden z-50">
      <div className="fixed inset-0 overflow-hidden bg-gray-500 bg-opacity-75">
        <div className="flex h-full">
          ...
          <div className="flex-none w-96 bg-white overflow-y-auto p-4 shopping-cart-dialog" style={{ display: 'none', height: 'calc(100vh - 3rem)', marginTop: '3.5rem' }}>
            <div className="flex justify-between items-center mb-4">
              ...
              >
                <FaTimes className="h-6 w-6" aria-hidden="true" /> {/* Use FaTimes icon */}
              </button>
            </div>
