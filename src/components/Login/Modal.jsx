...
const Modal = (props) => {
    ...
    <>  
        <button onClick={clickHandler} className={`absolute top-[10%] 2xl:top-[7%] xl:top-[15%] rounded-full px-3 py-1.5 bg-white text-black border-0 hover:bg-black hover:bg-opacity-80 hover:text-white focus:outline-none ${hoverTransition}`}>
            &#10006;
        </button>
        {children}
    </>, modalRoot)
