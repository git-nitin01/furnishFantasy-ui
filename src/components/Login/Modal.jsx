...
const Modal = (props) => {
    ...
    <>  
        <button onClick={clickHandler} className={`absolute top-1/3 sm:top-[calc(50vh - 270px)] rounded-full px-3 py-1.5 bg-white text-black border-0 hover:bg-black hover:bg-opacity-80 hover:text-white focus:outline-none ${hoverTransition}`}>
            &#10006;
        </button>
        {children}
    </>, modalRoot)
